...
public class Lesson31 {
	...
	private void initialize() {
		String usr = "dkkim";
		String path = "/Users/" + usr + "/eclipse-workspace/Lesson/img/";
		TableData td = new TableData();
		frame = new JFrame();
		frame.setBounds(100, 100, 450, 300);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		ImagePanel loginPanel = new ImagePanel(new ImageIcon(path + "theme.jpg").getImage());
		currPanel = loginPanel;
		ImagePanel tranPanel = new ImagePanel(new ImageIcon(path + "Activation.jpg").getImage());

		frame.setSize(loginPanel.getDim());
		frame.setPreferredSize(loginPanel.getDim());
		ImagePanel sumPanel = new ImagePanel(new ImageIcon(path + "Activation.jpg").getImage());
		...
		tranBtn.setIcon(new ImageIcon(path + "transaction.jpg"));
		...
		logInBtn.setIcon(new ImageIcon(path + "btn.jpg"));
		logInBtn.setPressedIcon(new ImageIcon(path + "btnClicked.jpg"));

		// Transaction

		JButton sumBtn = new JButton("");
		sumBtn.setIcon(new ImageIcon(path + "summary.jpg"));
